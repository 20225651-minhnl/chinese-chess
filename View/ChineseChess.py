...
from Rule.move import (
    get_xiangqi_king_moves, get_xiangqi_guard_moves, get_xiangqi_elephant_moves,
    get_xiangqi_knight_moves, get_xiangqi_pawn_moves, get_xiangqi_rook_moves,
    get_xiangqi_cannon_moves
)

# Initialize Pygame
pygame.init()

# Get the algorithm from command line arguments
if len(sys.argv) < 2:
    print("Error: No algorithm specified. Please choose an algorithm.")
    sys.exit(1)

algo = sys.argv[1]  # Algorithm of AI
print(f"Running with algorithm: {algo}")
